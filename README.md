...
> **Personal note:** I also found it helpful to run `uv self update` after installing to make sure you have the latest version before setting up the MCP server.
